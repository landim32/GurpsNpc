...
export class Greatsword extends Equipment {
    /**
     * 
     * @param {NpcInfo} npc 
     */
    DoEquipment(npc) {
        ...
        let w = new WeaponInfo("Espada Grande em GdP", 900, 3.5);
        w.STMin = 12;
        w.Damages = [
            new DamageInfo(DamageTypeEnum.GdP, 3, "2", DamagePenetrationEnum.Perf),
            new DamageInfo(DamageTypeEnum.GeB, 3, "1,2", DamagePenetrationEnum.Cont),
        ];
