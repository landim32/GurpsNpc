...
export class Warhammer extends Equipment {
    /**
     * 
     * @param {NpcInfo} npc 
     */
    DoEquipment(npc) {
        ...
        let w = new WeaponInfo("Martelo de Guerra", 100, 3.5);
        w.STMin = 12;
        w.Damages = [
            new DamageInfo(DamageTypeEnum.GeB, 3, "1,2", DamagePenetrationEnum.Perf)
        ];
